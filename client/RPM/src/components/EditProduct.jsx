...
const EditProduct = () => {
    ...
    const handleSearchProductByCode = async () => {
        ...
        setSuccess(null);
        try {
            const response = await Axios.get(`https://rpm-jgtt.onrender.com/product/code/${product.code}`);
            setProduct({
            ...
            const imageUrl = `https://rpm-jgtt.onrender.com/${response.data.image}`;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let response = await Axios.put(`https://rpm-jgtt.onrender.com/product/code/${product.code}/edit`, formData, { headers });
            ...
            if (response.status === 401) {
                ...
                response = await Axios.put(`https://rpm-jgtt.onrender.com/product/code/${product.code}/edit`, formData, { headers });
            }
    ...
    const handleDelete = async () => {
        ...
        if (isConfirmed) {
            try {
                ...
                let response = await Axios.delete(`https://rpm-jgtt.onrender.com/product/delete/${product.code}`, { headers });
                ...
                if (response.status === 401) {
                    ...
                    response = await Axios.delete(`https://rpm-jgtt.onrender.com/product/delete/${product.code}`, { headers });
                }
